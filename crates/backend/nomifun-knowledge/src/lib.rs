...
pub use service::{
    ...
    ManagedDocumentWriteDisposition, ManagedDocumentWriteOutcome, ManagedDocumentWriteRequest,
    RefreshSourceSummary, TurnWritebackFailure, TurnWritebackReport, TurnWritebackPhase,
    TurnWritebackRequest, TurnWritebackStatus, WriteMode, WriteOp, WriteOutcome, WritePolicy,
    WriteRequest, WriteResolution, WriteSurface, WriteTargetSpec, decode_doc_handle,
    encode_doc_handle, resolve_write_policy,
};
